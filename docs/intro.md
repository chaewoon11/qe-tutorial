...
:::info Status
This site is under active development. **Chapters 0–7** (all of Phase 1:
ground state + electronic structure) are complete and runnable; Phase 2
(functionals, magnetism, DFPT, HPC) is being written.
:::
